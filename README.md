...
`psychopy-lib` is a library-only implementation of [PsychoPy](https://pypi.python.org/pypi/PsychoPy), meaning that dependencies and code specific to running the PsychoPy app are removed for a faster installation.
